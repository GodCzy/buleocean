...
def _get_env_with_legacy_fallback(primary_key: str, legacy_key: str, default: str) -> str:
    ...
    if legacy_value is not None:
        warnings.warn(
            (
                "Legacy admin test credential environment variable is deprecated and will be removed after Phase 8. "
...
USERNAME = _get_env_with_legacy_fallback("BLUEOCEAN_SUPER_ADMIN_NAME", _legacy_brand_env("SUPER_ADMIN_NAME"), "zwj")
PASSWORD = _get_env_with_legacy_fallback(
    "BLUEOCEAN_SUPER_ADMIN_PASSWORD",
    _legacy_brand_env("SUPER_ADMIN_PASSWORD"),
    "zwj12138",
)
