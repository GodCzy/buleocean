...
LEGACY_DEFAULT_MILVUS_DB = "y" + "uxi_know"
...
class MilvusKB(KnowledgeBase):
    ...
    def __init__(self, work_dir: str, **kwargs):
        ...
        requested_milvus_db = kwargs.get("milvus_db")
        if requested_milvus_db == LEGACY_DEFAULT_MILVUS_DB:
            logger.warning("Legacy Milvus database name is deprecated; use 'blueocean_know' instead.")
        self.milvus_db = requested_milvus_db or "blueocean_know"
